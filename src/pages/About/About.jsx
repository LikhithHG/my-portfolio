...
const About = () => {
  ...
  return (
    <section
      id = 'about'
      className = 'h-screen py-16 px-6 md:px-20 bg-gradient-to-br from-gray-900 via-gray-800 to-gray-900'
    >
      <div className="flex flex-col justify-center items-center py-10">
        <h1 className="text-4xl md:text-5xl font-bold bg-gradient-to-r from-yellow-400 to-green-400 bg-clip-text text-transparent mb-6 mt-[-20px]">
          About me
        </h1>
      </div>
      <div className="max-w-7xl mx-auto flex flex-col md:flex-row items-center gap-50">
        ...
        <div className = 'relative w-full md:w-1/3 flex justify-center'>
          ...
          {/**skill Icons floating around the photo */}
          {
            techIcons.map(({Component, className, position}, index) => (
              <motion.div
                key = {index}
                className={`${position}`}
        ...
        <motion.div 
          ...
          viewport={{ once: true }}
          className="w-full md:w-2/3 text-center md:text-left flex flex-col min-h-[350px]"
        >
          {/* Tabs Navigation */}
          <div className="flex justify-center md:justify-center gap-6 mb-4">
            <button 
